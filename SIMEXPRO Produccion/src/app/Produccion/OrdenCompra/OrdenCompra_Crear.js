...
function OrdenCompra_Crear() {
    ...
    const rows = [{ id: "1", modelo: "Polo", talla: "L", progreso: "" }];
        ...
        <Card sx={{ minWidth: 275, margin: "40px" }}>
            ...
            <Box sx={{ bgcolor: "background.paper", width: "100%" }}>
                <AppBar position="static">
                    ...
                    >
                        <Tab
                            label="I. Datos Generales de la Orden de Compra"
                            {...a11yProps(0)}
                        />
                        <Tab
                                    ...
                                    <Grid item xs={12}>
                                        <FormControl fullWidth>
                                            ...
                                            >
                                                ...
                                                <MenuItem value={1}>YVES SAINT LAUREN</MenuItem>
                                                <MenuItem value={2}>GUCCI</MenuItem>
                                                <MenuItem value={3}>CHANNEL</MenuItem>
                                                <MenuItem value={4}>BALENCIAGA</MenuItem>
                                            </Select>
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={4}>
                                        <FormControl fullWidth>
                                            ...
                                            <DateTimePicker
                                                ...
                                                onChange={(date) => { }}
                                                renderInput={(_props) => (
                                                    <TextField className="w-full" {..._props} />
                                                )}
                                                className="w-full"
                                            />
                                        </FormControl>
                            ...
                            <CardContent>
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} style={{ textAlign: "center" }}>
                                        ...
                                        <label>
                                            En este campo puede añadir ejemplo de prendas terminadas y
                                    ...
                                    <Grid item xs={6} style={{ textAlign: "center" }}>
                                        ...
                                        <label>
                                            En este campo añadir el documento con las medidas
                                            especificadas por la prenda.
                                        </label>
                                    </Grid>
